...
class ResGCN_Module(nn.Module):
    def __init__(self, in_channels, out_channels, block, A, initial=False, stride=1, is_main_stream=False,
                 kernel_size=[5, 1], **kwargs):
...
#             max_graph_distance = [1, 3]
        ...
        self.scn = spatial_block(in_channels, out_channels, max_graph_distance, block_res,
                                 is_main_stream=is_main_stream, **kwargs)
